...
- 🔭 I contribute to both **frontend & backend development**, building web applications with:
  - **Java, Servlet, JSP, Hibernate, Spring Boot, MySQL, React, Vite, HTML, CSS, JavaScript, Bootstrap, Tailwind CSS**
- 🌱 Exploring **Technical Content Writing** to share knowledge with the developer community.
- ⚡ In my free time, I enjoy **solving coding challenges** on **GeeksforGeeks & LeetCode** and keeping up with **tech trends**.
